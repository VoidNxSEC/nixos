...

{
  ...
  options.kernelcore.applications.cache-optimization.enable =
    lib.mkEnableOption "browser/app cache optimizations"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.applications.cache-optimization.enable {
    # =================================================================

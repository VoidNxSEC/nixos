# vmctl CLI — shell script body (part of the vmctl/ split; see ./default.nix)
# Interpolations: source/VM dirs from kernelcore.virtualization, verbose/dryRun
# flags from kernelcore.virtualization.vmctl.
{ config, cfg }:

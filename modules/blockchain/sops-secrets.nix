...

{
  ...
  options.kernelcore.blockchain.sops-secrets.enable =
    lib.mkEnableOption "blockchain SOPS secrets wiring"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.blockchain.sops-secrets.enable {

...

{
  ...
  options.kernelcore.shell.aliases.nix-system.enable = lib.mkEnableOption "nix system aliases" // {
    default = true;
  };

  config = lib.mkIf config.kernelcore.shell.aliases.nix-system.enable {

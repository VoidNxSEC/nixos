...
in
{
  ...
  options.kernelcore.shell.aliases.navigation.enable = lib.mkEnableOption "navigation aliases" // {
    default = true;
  };

  config = lib.mkIf config.kernelcore.shell.aliases.navigation.enable {

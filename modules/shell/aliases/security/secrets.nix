...

{
  ...
  options.kernelcore.shell.aliases.secrets.enable =
    lib.mkEnableOption "secrets management aliases"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.shell.aliases.secrets.enable {

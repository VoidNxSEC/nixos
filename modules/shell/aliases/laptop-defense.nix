...

{
  ...
  options.kernelcore.shell.aliases.laptop-defense.enable =
    lib.mkEnableOption "laptop-defense aliases"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.shell.aliases.laptop-defense.enable {

...

{
  ...
  options.kernelcore.shell.aliases.emergency.enable =
    lib.mkEnableOption "emergency recovery aliases"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.shell.aliases.emergency.enable {

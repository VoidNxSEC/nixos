...

{
  ...
  options.kernelcore.shell.aliases.k8s-cluster.enable = lib.mkEnableOption "k8s cluster aliases" // {
    default = true;
  };

  config = lib.mkIf config.kernelcore.shell.aliases.k8s-cluster.enable {

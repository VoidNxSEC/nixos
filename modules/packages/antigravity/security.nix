...

{
  ...
  options.kernelcore.packages.antigravity.security.enable =
    lib.mkEnableOption "Antigravity sandboxing"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.packages.antigravity.security.enable {
    # ═══════════════════════════════════════════════════════════════

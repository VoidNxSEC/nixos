...

{
  ...
  options.kernelcore.packages.antigravity.tuning.enable =
    lib.mkEnableOption "Antigravity performance tuning"
    // {
      default = true;
    };

  config = lib.mkIf config.kernelcore.packages.antigravity.tuning.enable {
    # ═══════════════════════════════════════════════════════════════

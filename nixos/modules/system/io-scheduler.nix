...

{
  ...
  zramSwap = lib.mkForce {
    enable = true;
    priority = 100; # Max priority to ensure ZRAM is used first
    memoryPercent = 60; # Use up to 50% of RAM
    algorithm = "zstd";
  };
  ...
  boot.kernel.sysctl = lib.mkForce {
    ...
    "vm.dirty_ratio" = 20; # was 15 - allows larger buffer before forced flush
